...
router.post('/user_my_requiremtne_list', auth.userRequired, requirement.user_my_requiremtne_list); //获取我的装修需求列表
...
router.post('/designer_my_requiremtne_list', auth.designerRequired, requirement
