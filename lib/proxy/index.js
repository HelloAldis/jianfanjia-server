...
exports.UserMessage = factory.create_proxy(require('lib/models').UserMessage);
exports.DesignerMessage = factory.create_proxy(require('lib/models').DesignerMessage);
exports.Supervisor = factory.create_proxy(require('lib/models').Supervisor);
exports.Diary = factory.create_proxy(require('lib/models').Diary);
exports.DiarySet = factory.create_proxy(require('lib/models').DiarySet);
exports.Quotation = factory.create_proxy(require('lib/models').Quotation);
