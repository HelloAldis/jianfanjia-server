...
const apkDir = global.PROJECT_ROOT + '/web/pc/res/user_build';
const designerApkDir = global.PROJECT_ROOT + '/web/pc/res/designer_build';
const supervisorApkDir = global.PROJECT_ROOT + '/web/pc/res/supervisor_build';
