...
const apkDir = PROJECT_ROOT + '/web/pc/res/user_build';
const designerApkDir = PROJECT_ROOT + '/web/pc/res/designer_build';
const supervisorApkDir = PROJECT_ROOT + '/web/pc/res/supervisor_build';
