(function () {
  angular.module('JfjAdmin.pages.chart.user')
    .controller('DesignerChartController', ['$scope', '$rootScope', 'adminStatistic', '$filter', 'queryUtil',
      DesignerChartController
    ]);

  function DesignerChartController($scope, $rootScope, adminStatistic, $filter, queryUtil) {
    function initChart1() {
      var now = new Date();
      $scope.timeRanges1 = [];
      $scope.labels1 = [];
