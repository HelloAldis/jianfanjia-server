           ...
           $scope.dec_style = [
            ...
            if($stateParams.id == ''){        //发布新需求
                ...
                $scope.submitBtn = function(){
                    ...
                    userRequiremtne.add($scope.requiremtne).then(function(res){  //提交需求
            ...
            function stylePic(id){
                ...
                var $stylePic = $('#j-stylePic');
                var $picUl = $stylePic.find('ul');
                var $prev = $stylePic.find('.prev');
                var $next = $stylePic.find('.next');
                var $text = $stylePic.find('.text');
                var picWidth = $stylePic.width();
                var str = '';
                $.each(arr, function(index, val) {
                    str += '<li><img src="'+val.url+'" alt="'+val.txt+'" /></li>'
                });
                $picUl.html(str)
                var $picLi = $picUl.find('li');
                $picUl.width($picLi.size()*picWidth)
                ...
                function fnMove(){
                    $picUl.animate({left:-iNum*picWidth})
                    $text.html(arr[iNum].txt)
                }               
                return iNum
            }
    }])
